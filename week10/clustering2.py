...
celltypematrix=dataMatrix.T
#calculate distance matrix and convert to squareform
distanceMatrix = dist.pdist(celltypematrix)
...
print 'var maxData = ' + str(numpy.amax(celltypematrix)) + ";"
print 'var minData = ' + str(numpy.amin(celltypematrix)) + ";"
